...
//       if (isEdit) {
//         res = await updateTransaction(initialData._id, payload);
//       } else {
...
//           exit={{ y: 40, opacity: 0 }}
//           className="relative z-10 w-full max-w-lg rounded-2xl bg-white shadow-xl border border-slate-200"
//         >
...
//                 type="submit"
//                 disabled={loading}
//                 className="px-4 py-2 text-sm bg-slate-900 text-white rounded-xl flex items-center gap-2"
//               >
//                 {loading && (
