...
//   const currentStatus =
//     statusConfig[connectionState] || statusConfig.offline;

//   const StateIcon = currentStatus.icon;
...
//   return (
//     <div className="w-full bg-white border border-slate-200 rounded-3xl px-4 sm:px-6 py-4 shadow-sm">
...
//             className="p-2 rounded-xl border border-slate-200 hover:bg-slate-50 disabled:opacity-50 transition"
//           >
//             <RefreshCcw
//               size={18}
